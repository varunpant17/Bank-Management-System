  ...
  <form action="" method="POST">
    ...
    <table width="80%">
      <tr>
        ...
        <td>
          <input type="text" name="Aadhaar Number" class="question" id="Aadhaar Number" value="<?php echo $phone ?>" required autocomplete="off" />
          <label for="Aadhaar Number"><span>Aadhaar Number*</span></label>
        </td>
      </tr>
    </table>
    <hr width="80%">
