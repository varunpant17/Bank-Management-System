...
<br><br>
<div align="center" style="background-color: #0076f4; height: 70px; width: 100%; color: white; position: absolute; top: 13%;"><h1>New User Registration</h1>
  <p>* All Field are Mandatory</p></div>
  <div><p align="center" style="color: red; position: absolute; top: 25%; left: 43%">Password does not match the confirm password</p></div>
